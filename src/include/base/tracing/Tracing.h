...
#define EVENT_TRACER_Syscall_activaterp()   EVENT_TRACER(28);
#define EVENT_TRACER_Syscall_revoke()       EVENT_TRACER(29);
#define EVENT_TRACER_Syscall_idle()         EVENT_TRACER(30);
#define EVENT_TRACER_Syscall_exit()         EVENT_TRACER(31);
// service commands
#define EVENT_TRACER_Service_open()         EVENT_TRACER(32);
#define EVENT_TRACER_Service_obtain()       EVENT_TRACER(33);
#define EVENT_TRACER_Service_delegate()     EVENT_TRACER(34);
#define EVENT_TRACER_Service_close()        EVENT_TRACER(35);
#define EVENT_TRACER_Service_shutdown()     EVENT_TRACER(36);
#define EVENT_TRACER_Service_request()      EVENT_TRACER(37);
// fs commands
