...
#define EVENT_TRACER_Syscall_createsgate()  EVENT_TRACER(16);
#define EVENT_TRACER_Syscall_createmgate()  EVENT_TRACER(17);
#define EVENT_TRACER_Syscall_createvpe()    EVENT_TRACER(18);
#define EVENT_TRACER_Syscall_createmap()    EVENT_TRACER(19);
#define EVENT_TRACER_Syscall_activate()     EVENT_TRACER(20);
...
#define EVENT_TRACER_Syscall_revoke()       EVENT_TRACER(26);
