...
#define EVENT_TRACER_Syscall_creategate()   EVENT_TRACER(15);
#define EVENT_TRACER_Syscall_createvpe()    EVENT_TRACER(16);
#define EVENT_TRACER_Syscall_createmap()    EVENT_TRACER(17);
#define EVENT_TRACER_Syscall_attachrb()     EVENT_TRACER(18);
#define EVENT_TRACER_Syscall_detachrb()     EVENT_TRACER(19);
#define EVENT_TRACER_Syscall_exchange()     EVENT_TRACER(20);
#define EVENT_TRACER_Syscall_vpectrl()      EVENT_TRACER(21);
#define EVENT_TRACER_Syscall_reqmem()       EVENT_TRACER(22);
#define EVENT_TRACER_Syscall_derivemem()    EVENT_TRACER(23);
#define EVENT_TRACER_Syscall_delegate()     EVENT_TRACER(24);
#define EVENT_TRACER_Syscall_obtain()       EVENT_TRACER(25);
#define EVENT_TRACER_Syscall_delob_done()   EVENT_TRACER(26);
#define EVENT_TRACER_Syscall_activate()     EVENT_TRACER(27);
#define EVENT_TRACER_Syscall_forwardmsg()   EVENT_TRACER(28);
#define EVENT_TRACER_Syscall_forwardmem()   EVENT_TRACER(29);
#define EVENT_TRACER_Syscall_forwardreply() EVENT_TRACER(30);
#define EVENT_TRACER_Syscall_revoke()       EVENT_TRACER(31);
#define EVENT_TRACER_Syscall_idle()         EVENT_TRACER(32);
#define EVENT_TRACER_Syscall_noop()         EVENT_TRACER(33);
...
#define EVENT_TRACER_Service_request()      EVENT_TRACER(40);
// fs commands
#define EVENT_TRACER_FS_open()              EVENT_TRACER(41);
#define EVENT_TRACER_FS_seek()              EVENT_TRACER(42);
#define EVENT_TRACER_FS_stat()              EVENT_TRACER(43);
#define EVENT_TRACER_FS_fstat()             EVENT_TRACER(44);
#define EVENT_TRACER_FS_mkdir()             EVENT_TRACER(45);
#define EVENT_TRACER_FS_rmdir()             EVENT_TRACER(46);
#define EVENT_TRACER_FS_link()              EVENT_TRACER(47);
#define EVENT_TRACER_FS_unlink()            EVENT_TRACER(48);
#define EVENT_TRACER_FS_close()             EVENT_TRACER(49);
#define EVENT_TRACER_FS_getlocs()           EVENT_TRACER(50);
// main
#define EVENT_TRACER_Main()                 EVENT_TRACER(51);
#define EVENT_TRACER_Lambda()               EVENT_TRACER(52);
// kernel
#define EVENT_TRACER_Kernel_Timeouts()      EVENT_TRACER(53);
