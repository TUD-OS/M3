...
#define EVENT_TRACER_Syscall_setpfgate()    EVENT_TRACER(23);
#define EVENT_TRACER_Syscall_attachrb()     EVENT_TRACER(24);
#define EVENT_TRACER_Syscall_detachrb()     EVENT_TRACER(25);
#define EVENT_TRACER_Syscall_exchange()     EVENT_TRACER(26);
#define EVENT_TRACER_Syscall_vpectrl()      EVENT_TRACER(27);
#define EVENT_TRACER_Syscall_reqmem()       EVENT_TRACER(28);
#define EVENT_TRACER_Syscall_derivemem()    EVENT_TRACER(29);
#define EVENT_TRACER_Syscall_delegate()     EVENT_TRACER(30);
#define EVENT_TRACER_Syscall_obtain()       EVENT_TRACER(31);
#define EVENT_TRACER_Syscall_delob_done()   EVENT_TRACER(32);
#define EVENT_TRACER_Syscall_activate()     EVENT_TRACER(33);
#define EVENT_TRACER_Syscall_revoke()       EVENT_TRACER(34);
#define EVENT_TRACER_Syscall_exit()         EVENT_TRACER(35);
// service commands
#define EVENT_TRACER_Service_open()         EVENT_TRACER(36);
#define EVENT_TRACER_Service_obtain()       EVENT_TRACER(37);
#define EVENT_TRACER_Service_delegate()     EVENT_TRACER(38);
#define EVENT_TRACER_Service_close()        EVENT_TRACER(39);
#define EVENT_TRACER_Service_shutdown()     EVENT_TRACER(40);
// fs commands
