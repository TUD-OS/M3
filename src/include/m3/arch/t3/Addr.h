...
#define ASPLOS2   //2MB Data; 128KB Instr.
//#define BENECMDTEST
...
#ifdef ASPLOS2
  #define PE_IMEM_CFG_START_ADDR 0x60800000
  #define PE_UMEM_CFG_START_ADDR 0x60400000
#else
...
#ifdef ASPLOS2  //to have an increased imem available)
  #define CM_SO_PE_INST_POINTER   0x6084F000
  #define CM_SO_PE_DATA_COUNT     0x6084F008
  #define CM_SO_PE_ARG_0          0x6084F010
  #define CM_SO_PE_ARG_1          0x6084F018
  #define CM_SO_PE_ARG_2          0x6084F020
  #define CM_SO_PE_ARG_3          0x6084F028
  #define CM_SO_PE_ARG_4          0x6084F030
  #define CM_SO_PE_ARG_5          0x6084F038
  #define CM_SO_PE_ARG_6          0x6084F040
  #define CM_SO_PE_ARG_7          0x6084f048
  #define CM_SO_PE_ARG_8          0x6084F050
  #define CM_SO_PE_ARG_9          0x6084F058
  #define CM_SO_PE_ARG_10         0x6084F060
  #define CM_SO_PE_ARG_11         0x6084F068

  #define CM_SO_PE_TASK_INCREMENT 0x80 //0x88

  #define CM_SO_PE_TASK_FINISHED  CM_SO_PE_INST_POINTER
  #define CM_SO_PE_CLEAR_IRQ      0x6084E070
  #define CM_SO_PE_LOCAL_MEM      0x60000000  //TODO: HAS TO BE UPDATED DUE TO NEW MEMORY MAP!
  #define CM_SO_PE_DMA_CONFIG     0x6084E078
  #define CM_SO_PE_DMA_LOCK_REQ   0x6084E0A0
...
#define IDMA_CONFIG_ADDR_PREFIX             0xE
#define IDMA_CONFIG_ADDR                    (IDMA_CONFIG_ADDR_PREFIX << 28) // 0xF0000000
#define IDMA_DATA_PORT_ADDR                 (IDMA_CONFIG_ADDR + 0x01000000)
#ifdef ASPLOS2 //more memory (T4-Spec)
  #define PE_IDMA_CONFIG_ADDRESS_MASK         0x00007E00  //defines the bits, necessary to identify action
  #define PE_IDMA_CONFIG_ADDRESS              0x60610000
  #define PE_IDMA_CONFIG_END_ADDRESS          0x6061FE40
#elif defined ASPLOS
  #define PE_IDMA_CONFIG_ADDRESS_MASK         0x00007E00  //defines the bits, necessary to identify action
  #define PE_IDMA_CONFIG_ADDRESS              0x60008000 // should be blocked!
  #define PE_IDMA_CONFIG_END_ADDRESS          0x6000FE40
#else
  #define PE_IDMA_CONFIG_ADDRESS_MASK         0x0001FC00  //defines the bits, necessary to identify action
  #define PE_IDMA_CONFIG_ADDRESS              0x60018000 // should be blocked!
  #define PE_IDMA_CONFIG_END_ADDRESS          0x6001FFFF
#endif
...
#if (defined ASPLOS) || (defined ASPLOS2)
  #define PE_IDMA_SLOT_FIFO_RELEASE_ELEM      0xA000D000    //DEPRECATED
#else
...
#if (defined ASPLOS) || (defined ASPLOS2)
  #define IDMA_SLOT_TRG_ID_MASK             0x3   //number of targets from idma_defines!
#else
...
/*#else //(T4 Spec)                               --------------------------TODO: T4!!!
  #define IDMA_OVERALL_WRITE_MODE_MASK      0x0
  #define IDMA_TRF_TYPE_READ                0x0
  #define IDMA_TRF_TYPE_WRITE               0x1
  #define IDMA_TRF_TYPE_STREAMREAD          0x2
  #define IDMA_TRF_TYPE_STREAM_WRITE        0x3
#endif
*/
...
#define EXTERN_CFG_ADDRESS_MODULE_CHIP_CTA_INC_CMD   0x3
#define EXTERN_CFG_SIZE_CREDITS_CMD                  0x4
#define HEADER_CFG_REPLY_LABEL_SLOT_ENABLE_ADDR      0x5

#ifdef BENECMDTEST
#define FILTER_CFG_MASK_CMD                          0x7
//#define FILTER_CFG_MASK2_CMD                          0x4   //DELETED 18.06.
#define FILTER_CFG_OPERAND1_CMD                       0x8     //OLD: 0x5
//#define FILTER_CFG_OPERAND2_CMD                       0x6   //DELETED 18.06.
#define FILTER_CFG_OPERATION_SIZE_CMD                 0x9     //OLD: 0x6
#define FILTER_CFG_TRANSFER_MASK0_CMD                 0xA     //ADDED 18.06
#define FILTER_CFG_TRANSFER_MASK1_CMD                 0xB     //OLD: 0x8   //eventuell: mit subgroup zusasmmenlegen!
#define FILTER_CFG_TRANSFER_MASK2_CMD                 0xC
#define FILTER_CFG_DISTRMASK1_CMD                     0xD
//#define FILTER_CFG_DISTRMASK2_CMD                     0xD   //DELETED
#define FILTER_CFG_TRANSFER_LABEL1_CMD                0xE
//#define FILTER_CFG_TRANSFER_LABEL2_CMD                0xB   //DELETED
#define FIRE_CMD                                      0x6

#else

#define FILTER_CFG_MASK_CMD                          0x6
//#define FILTER_CFG_MASK2_CMD                          0x4   //DELETED 18.06.
#define FILTER_CFG_OPERAND1_CMD                       0x7     //OLD: 0x5
//#define FILTER_CFG_OPERAND2_CMD                       0x6   //DELETED 18.06.
#define FILTER_CFG_OPERATION_SIZE_CMD                 0x8     //OLD: 0x6
#define FILTER_CFG_TRANSFER_MASK0_CMD                 0x9     //ADDED 18.06
#define FILTER_CFG_TRANSFER_MASK1_CMD                 0xA     //OLD: 0x8   //eventuell: mit subgroup zusasmmenlegen!
#define FILTER_CFG_TRANSFER_MASK2_CMD                 0xB
#define FILTER_CFG_DISTRMASK1_CMD                     0xC
//#define FILTER_CFG_DISTRMASK2_CMD                     0xD   //DELETED
#define FILTER_CFG_TRANSFER_LABEL1_CMD                0xD
//#define FILTER_CFG_TRANSFER_LABEL2_CMD                0xB   //DELETED

#define FIRE_CMD                                      0xE
#endif

#define DEBUG_CMD                                     0xF
#define REPLY_CAP_RESP_CMD                            0x10

#define IDMA_CREDIT_RESPONSE_CMD                      0x11
#define ALLOWED_MEMORY_MODULE_LOCATION_CMD            0x12
#define ALLOWED_MEMORY_MODULE_LOCK                    0x13     //OLD: #define ALLOWED_MODULE_LOCATION_CMD                   0x16
#define IDMA_FIRST_STATUS_CMD                         0x14

#define IDMA_CM_SPINOFF_REG_STATUS                    0x14
#define IDMA_OVERALL_SLOT_STATUS                      0x15
#define IDMA_CREDIT_STATUS                            0x16
#define IDMA_SLOT_FIFO_ELEM_CNT                       0x17    //TODO: group with targetId
#define IDMA_SLOT_FIFO_GET_ELEM                       0x18    //TODO: group with targetId
#define IDMA_SLOT_FIFO_RELEASE_ELEM                   0x19    //TODO: group with targetId
#define IDMA_PORT_CREDIT_STATUS                       0x1A
#define IDMA_SLOT_SIZE_STATUS                         0x1B


#define IDMA_CREDIT_COMPARE_EXCHANGE                  0x1C    //TODO: UPDATE!
