...
MEMORY
{
  dram0_0_seg :                         org = 0x607FD000, len = 0x1000
  iram0_0_seg :                         org = 0x60800000, len = 0x2E0
  iram0_2_seg :                         org = 0x60800400, len = 0x178
  iram0_3_seg :                         org = 0x60800578, len = 0x4
  iram0_4_seg :                         org = 0x6080057C, len = 0x1C
  iram0_5_seg :                         org = 0x60800598, len = 0x4
  iram0_6_seg :                         org = 0x6080059C, len = 0x1C
  iram0_7_seg :                         org = 0x608005B8, len = 0x4
  iram0_8_seg :                         org = 0x608005BC, len = 0x1C
  iram0_9_seg :                         org = 0x608005D8, len = 0x4
  iram0_10_seg :                        org = 0x608005DC, len = 0x1C
  iram0_11_seg :                        org = 0x6081FA00, len = 0x600
}
...
ENTRY(_ResetVector)
_rom_store_table = 0;
PROVIDE(_memmap_vecbase_reset = 0x60800400);
PROVIDE(_memmap_reset_vector = 0x60800000);
