...
public:
    ...
    static size_t get_extent_mem(FSHandle &h, m3::INode *inode, size_t extent, size_t extoff, size_t *extlen,
                                 int perms, capsel_t sel, bool dirty, UsedBlocks *used_blocks, size_t accessed);
    static size_t req_append(FSHandle &h, m3::INode *inode, size_t i, size_t extoff, size_t *extlen, capsel_t sel,
                             int perm, m3::Extent *ext, UsedBlocks *used_blocks, size_t accessed);
    static m3::Errors::Code append_extent(FSHandle &h, m3::INode *inode, m3::Extent *next,size_t *prev_ext_len, UsedBlocks *used_blocks);

    static m3::Extent *get_extent(FSHandle &h, m3::INode *inode, size_t i,
                                  m3::Extent **indir, bool create, UsedBlocks *used_blocks);
    static m3::Extent *change_extent(FSHandle &h, m3::INode *inode, size_t i,
                                     m3::Extent **indir, bool remove, UsedBlocks *used_blocks);
    static void fill_extent(FSHandle &h, m3::INode *inode, m3::Extent *ext, uint32_t blocks, size_t accessed);

    static void truncate(FSHandle &h, m3::INode *inode, size_t extent, size_t extoff, UsedBlocks *used_blocks);
